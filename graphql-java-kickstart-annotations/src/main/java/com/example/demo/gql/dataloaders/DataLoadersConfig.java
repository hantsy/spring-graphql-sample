    ...
    GraphQLServletContextBuilder graphQLServletContextBuilder(AuthorService authorService, PostService postService) {
        return new DefaultGraphQLServletContextBuilder() {
            ...
            private DataLoaderRegistry buildDataLoaderRegistry() {
                ...
                dataLoaderRegistry.register("authorsLoader",
                        DataLoaderFactory.newDataLoader(new AuthorsDataLoader(authorService)));
                dataLoaderRegistry.register("commentsLoader",
                        DataLoaderFactory.newMappedDataLoader(new CommentsDataLoader(postService)));
