...
plugins {
    ...
    id("com.netflix.dgs.codegen") version "5.5.0" //https://plugins.gradle.org/plugin/com.netflix.dgs.codegen
}
...
dependencies {
    ...
    testImplementation("io.kotest:kotest-framework-concurrency:5.5.3")
}
